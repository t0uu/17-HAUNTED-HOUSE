...
renderer.setSize(sizes.width, sizes.height)
renderer.setPixelRatio(Math.min(window.devicePixelRatio, 2))
// To fix background, we must change the clear color of the renderer and use the same color as the fog
...
const tick = () =>
{
    ...
    ghost3.position.z = Math.sin(ghost3Angle) * (7 + Math.sin(elapsedTime * 0.1))
